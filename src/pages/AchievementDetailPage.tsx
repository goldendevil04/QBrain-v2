              ...
              <div className="relative group mb-12">
                ...
                <div className="relative bg-slate-800/50 border border-yellow-400/30 rounded-3xl p-8 backdrop-blur-sm">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <span className={`px-4 py-2 text-sm rounded-full font-semibold ${achievement.category === 'hackathon' ? 'bg-purple-400/20 text-purple-400' :
                    ...
                    <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
                      {achievement.images.map((image: string, index: number) => (
                        <button
                          ...
                          className={`relative group aspect-square rounded-lg overflow-hidden border-2 transition-all duration-300 ${selectedImageIndex === index
                              ? 'border-cyan-400'
